...
export const createOrUpdateDeliveryManagement = async (
    ...
    const deliveryManagement = await deliveryManagementService.createOrUpdateDeliveryManagement(req.body);
...
export const getDeliveryManagementByGroupId = async (
    ...
    const deliveryManagement = await deliveryManagementService.getDeliveryManagementByGroupId(pincodeGroupId);
...
export const getAllDeliveryManagements = async (
    ...
    const result = await deliveryManagementService.getAllDeliveryManagements(page, limit);
...
export const deleteDeliveryManagement = async (
    ...
    const result = await deliveryManagementService.deleteDeliveryManagement(pincodeGroupId);
